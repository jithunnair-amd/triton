 ...
 * hipDriverGetVersion() would return on the system.
 *
 ...
 * hipDeviceAttributeComputeCapabilityMinor and
 * hipDeviceAttributeComputeCapabilityMajor attributes that would be
 * returned by CUDA's hipDeviceGetAttribute().
 *
 * @param device                               The identifier of the target device
