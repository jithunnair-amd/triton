...
typedef struct hipArray *hipArray *;                       /**< CUDA array */
 ...
 */
#define HIP_LAUNCH_PARAM_END 64

/**
 * CUDA IPC event handle
 */
typedef struct CUipcEventHandle_st {
    char reserved[HIP_LAUNCH_PARAM_END];
} hipIpcEventHandle;
...
typedef enum hipDeviceAttribute_t {
    ...
    hipDeviceAttributeAsyncEngineCount = 15,                       /**< Device can possibly copy memory and execute a kernel concurrently. Deprecated. Use instead hipDeviceAttributeAsyncEngineCount. */
    ...
    hipDeviceAttributeMaxTexture2DLayeredWidth = 27,     /**< Deprecated, use hipDeviceAttributeMaxTexture2DLayeredWidth */
    hipDeviceAttributeMaxTexture2DLayeredHeight = 28,    /**< Deprecated, use hipDeviceAttributeMaxTexture2DLayeredHeight */
    hipDeviceAttributeMaxTexture2DLayeredLayers = 29, /**< Deprecated, use hipDeviceAttributeMaxTexture2DLayeredLayers */
 ...
 * ::hipMemAdvise
 */
hipError_t CUDAAPI hipMemAdvise(hipDeviceptr_t devPtr, size_t count, hipMemAdvise advice, hipDevice_t device);
